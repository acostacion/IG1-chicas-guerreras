...
WingAdvancedTIE::WingAdvancedTIE(GLdouble w, GLdouble h, GLboolean modulate, Texture* tex)
...
AdvancedTIE::AdvancedTIE(Texture* wingsTex, GLboolean alfaActive) : mAlfaActive(alfaActive)
{
	...
	// ----- ALA 1 -----
	WingAdvancedTIE* WATIE = new WingAdvancedTIE(100, 50, false, wingsTex);		// entidad
	WATIE->setModelMat(translate(glm::dmat4(1), glm::dvec3(0, 0, -wingsDistance / 2))); // se mueve la wingdistance para colocarla
	addEntity(WATIE);

	// ----- ALA 2 -----
	WingAdvancedTIE* WATIE2 = new WingAdvancedTIE(100, 50, false, wingsTex);		// entidad
	WATIE2->setModelMat(
